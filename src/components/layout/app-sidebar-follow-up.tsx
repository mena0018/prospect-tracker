...
import { AppSidebarFollowUpBurst } from '@/components/layout/app-sidebar-follow-up-burst'
...
export function AppSidebarFollowUp({ dueCount, doneToday, hasPipeline, onStart }: Props) {
